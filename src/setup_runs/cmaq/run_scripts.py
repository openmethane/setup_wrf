        ...
        for idomain, domain in enumerate(domains):
            ...
            subsCctm = [
                [
                    ...
                    "source {}/scripts/config.cmaq".format(CMAQdir),
                ],
                ...
                [
                    ...
                    "setenv GRIDDESC {}/GRIDDESC".format(mcipdir),
                ],
                ...
                [
                    ...
                    "setenv OCEAN_1 $SZpath/surfzone_{}.nc".format(domain),
                ],
...
def prepareBconRunScripts(
    ...
    for idate, date in enumerate(dates):
        ...
        for idomain, domain in enumerate(domains):
            ...
            if idomain != 0:
                lastmcipdir = "{}/{}/{}".format(
                    ctmDir, yyyymmdd_dashed, domains[idomain - 1]
                )
                ...
                input3Dconfile = "{}/{}_{}_{}/CONC.{}".format(
                    ctmDir, mech, domains[idomain - 1], sufadjname, yyyymmdd
                )
                MetCro3dCrs = "{}/METCRO3D_{}".format(
                    lastmcipdir, mcipsuffix[idomain - 1]
                )
                ...
                subsBcon = [
                    ...
                    [
                        ...
                        "setenv LAYER_FILE {}".format(MetCro3dFin),
                    ],
                    ...
                    [
                        ...
                        "setenv CTM_CONC_1 {}".format(input3Dconfile),
                    ],
                    [
                        "setenv MET_CRO_3D_CRS TEMPLATE",
                        "setenv MET_CRO_3D_CRS {}".format(MetCro3dCrs),
                    ],
                    [
                        "setenv MET_CRO_3D_FIN TEMPLATE",
                        "setenv MET_CRO_3D_FIN {}".format(MetCro3dFin),
                    ],
                ]
                ##
                print(
...
def prepareTemplateBconFiles(
    ...
    for idomain, domain in enumerate(domains):
        ...
        subsBcon = [
            ...
            [
                "setenv LAYER_FILE TEMPLATE/METCRO3D_TEMPLATE",
                "setenv LAYER_FILE {}/METCRO3D_{}".format(mcipdir, mcipsuffix[idomain]),
            ],
